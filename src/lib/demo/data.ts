...
// ============================================================================
// FORMS - One service per estimator
// ============================================================================
...
export const DEMO_FORMS = [
  {
    id: 'form-panel',
    company_id: DEMO_COMPANY.id,
    name: 'Panel Upgrade Estimator',
    slug: 'panel-upgrade',
    description: 'Get an instant estimate for electrical panel upgrades',
    is_active: true,
    job_type_ids: ['jt-panel'],
    settings: {
  ...
  },
  {
    id: 'form-outlet',
    company_id: DEMO_COMPANY.id,
    name: 'Outlet Installation Estimator',
    slug: 'outlet-installation',
    description: 'Get an instant estimate for outlet installation',
    is_active: true,
    job_type_ids: ['jt-outlet'],
    settings: {
      show_price_range: true,
      require_phone: false,
      require_address: true,
  ...
  },
  {
    id: 'form-lighting',
    company_id: DEMO_COMPANY.id,
    name: 'Lighting Installation Estimator',
    slug: 'lighting-installation',
    description: 'Get an instant estimate for lighting installation',
    is_active: true,
    job_type_ids: ['jt-lighting'],
    settings: {
      show_price_range: true,
      require_phone: false,
      require_address: true,
  ...
  },
  {
    id: 'form-ev',
    company_id: DEMO_COMPANY.id,
    name: 'EV Charger Installation Estimator',
    slug: 'ev-charger',
    description: 'Get an instant estimate for EV charger installation',
    is_active: true,
    job_type_ids: ['jt-ev'],
    settings: {
      show_price_range: true,
  ...
  },
  {
    id: 'form-rewire',
    company_id: DEMO_COMPANY.id,
    name: 'Whole House Rewiring Estimator',
    slug: 'rewiring',
    description: 'Get an instant estimate for whole house rewiring',
    is_active: true,
    job_type_ids: ['jt-rewire'],
    settings: {
      show_price_range: true,
      require_phone: true,
      require_address: true,
      success_message: 'Thank you! A project manager will contact you within 1 business day.',
    },
    created_at: '2024-02-01T10:00:00Z',
    updated_at: '2024-02-01T10:00:00Z',
  },
  {
    ...
    slug: 'ceiling-fan',
    description: 'Get an instant estimate for ceiling fan installation',
    is_active: true,
    job_type_ids: ['jt-ceiling-fan'],
    settings: {
      show_price_range: true,
      require_phone: false,
      require_address: true,
  ...
  },
  {
    id: 'form-generator',
    company_id: DEMO_COMPANY.id,
    name: 'Generator Installation Estimator',
    slug: 'generator',
    description: 'Get an instant estimate for generator installation',
    is_active: true,
    job_type_ids: ['jt-generator'],
    settings: {
      show_price_range: true,
      require_phone: true,
      require_address: true,
  ...
  },
  {
    id: 'form-smart-home',
    company_id: DEMO_COMPANY.id,
    name: 'Smart Home Wiring Estimator',
    slug: 'smart-home',
    description: 'Get an instant estimate for smart home wiring',
    is_active: true,
    job_type_ids: ['jt-smart-home'],
    settings: {
      show_price_range: true,
      require_phone: false,
      require_address: true,
